  ...
  return (
    <header className="flex flex-wrap items-start justify-between gap-5">
      <div className="min-w-[280px] flex-1">
        <nav aria-label="Breadcrumb" className="mb-4 flex items-center gap-2 py-0.5 text-[12px] text-slate-400">
        ...
        <h1 className="text-[26px] leading-tight font-bold tracking-tight text-[#0f1f47]">
          {title}
        </h1>
        <p className="mt-2 max-w-[980px] text-[15px] leading-relaxed font-normal text-slate-500">
          {subtitle}
        </p>
      </div>
